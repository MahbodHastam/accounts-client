<template>
    <div>
        ...
        <div class="section">
            ...
            <p>The security service is designed to give you personalized recommendations to secure your accounnts and wallets</p>
            <router-link to="">check up >></router-link>
        </div>
        <div class="outer">
            <p>Only you can see your settings. You might also want to review your settings for Audiofy, Vidible, or whichever Myren services you use most. Myren keeps your data private, safe, and secure</p>
        </div>
    </div>
</template>
<script>
